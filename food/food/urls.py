...
urlpatterns = [
    ...
    url(r'^recipes/model$', views.recipe_model, name='recipes/model'),
    url(r'^ingredients/model$', views.ingredient_model, name='ingredients/model'),
    url(r'^cuisines/model$', views.cuisine_model, name='cuisines/model'),
