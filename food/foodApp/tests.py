...
class ModelTestCase(TestCase):
	...
	self.assertEqual(ingredients_get.quant_data, test_dict["quant_data"])
	self.assertEqual(ingredients_get.nut_info, test_dict["nut_info"])
	self.assertEqual(ingredients_get.all_cuisines, test_dict["all_cuisines"])
	self.assertEqual(ingredients_get.all_recipes, test_dict["all_recipes"])
